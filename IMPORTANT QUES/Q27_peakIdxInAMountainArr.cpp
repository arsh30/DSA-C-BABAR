...
/*
Logic -> if (arr [mid] < arr[mid + 1] ){ means vo left wali line par lie krta hai
Toh s = ko mid + 1 krege taki peak elem find kr ske
}

Ab Agr vo left wali line pr Nahi h toh right pr hi hoga ya mid hi peak elem hoga
e = mid -> Agr mid - 1 krte hai toh , agr mid hi peak elem hua toh wapas first
line par aajega that is why humne yeh kra

And dr key Nahi h jisse compare krwakr dekhle ki voi mid hai isliye e = mid kra
